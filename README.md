This is my first attempt at making a mobile application
...
Still in the works features:
  ...
  - Allow users to upload photos from device (Cannot due to Firebase requiring the paid tier to use storage, but may end up using a separate storage solution, such as a google drive, or drop box)
